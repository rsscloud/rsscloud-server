module.exports = {
    error: {
        ...
        ping: {
            tooRecent: (minSeconds, lastPingSeconds) =>
                `Can't accept the request because the minimum seconds between pings is ${minSeconds} and you pinged us ${lastPingSeconds} seconds ago.`,
            readResource: url =>
                `The ping was cancelled because there was an error reading the resource at URL ${url}.`
        },
        rpc: {
            notEnoughParams: method =>
                `Can't call "${method}" because there aren't enough parameters.`,
            tooManyParams: method =>
